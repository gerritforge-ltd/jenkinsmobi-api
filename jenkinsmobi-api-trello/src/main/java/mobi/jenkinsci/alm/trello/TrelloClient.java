...
public class TrelloClient implements ALMClient {
  ...
  @Inject
  public TrelloClient(PluginConfig pluginConf, Config config, HttpClientFactory httpClientFactory) throws RemoteException {
    ...
    jsonCache = new LazyCacheMap<String, TrelloObject>(httpLoader, config);
    jsonArrayCache = new LazyCacheMap<String, TrelloObject[]>(httpArrayLoader, config);
