...
public class HttpClientURLDownloaderTest {
  ...
  @Mock
  private HttpServletRequest mockPluginRequest;
  ...
  @Captor
  private ArgumentCaptor<HttpRequestBase> httpUriRequestCaptor;

  @InjectMocks
  private HttpClientURLDownloader httpClientDownloader;
  ...
  public void httpGetRemoteUrlReturnsRawBinaryNode() throws IOException {
    ...
    final RawBinaryNode responseNode =
        httpClientDownloader.internalQueryForDownload(mockPluginRequest,
