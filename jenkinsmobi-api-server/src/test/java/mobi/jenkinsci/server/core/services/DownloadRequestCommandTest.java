...
public class DownloadRequestCommandTest {
  ...
  public void setUp() throws ClientProtocolException, IOException {
    ...
    when(
        mockUrlDownloader.download(any(HttpServletRequest.class), any(String.class), any(Account.class), any(PluginConfig.class))).thenReturn(
        mockBinaryNode);
  }
  ...
  public void shouldProcessDownloadThroughPluginProvidedUrlDownloader()
      throws IOException {
    when(mockPluginLoader.get(A_PLUGIN_TYPE)).thenReturn(
  ...
  public void shouldProcessDownloadThroughEmbeddedUrlDownloaderIfPluginDoesNotSupportUrlDownload()
    ...
    verify(mockUrlDownloader).download(any(HttpServletRequest.class), any(String.class), same(mockAccount), same(mockPluginConfig));
  }
